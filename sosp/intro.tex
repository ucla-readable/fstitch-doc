...
%
A PostMark test that writes approximately 4~GB of data
 requires 41~MB of memory to store \patches\ and
 soft updates-like dependencies, less than 2\% of the memory used for file
