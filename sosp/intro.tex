...
\Chdescs\ may be examined and modified by other modules
 as well, and even passed through layers such as loop-back block devices.
%
...
Although implementation experience is preliminary, and \chdescs\
 ...
 design will allow the construction of consistent, modular,
...
Our contributions include the generalized \chdesc\ design,
 ...
 module and the write-back cache, and the \opgroup\ interface that
