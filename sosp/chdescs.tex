...
a level, the \chdesc\ is added to its owner's ready list. To create a
...
Saving Data and Merging Chdescs

NRBs, single NRB per block, ddesc external after count, propagation, \ldots
