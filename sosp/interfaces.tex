...
operations. A generic CFS-to-\LFS\ \module\ called UHFS decomposes the larger file write,
read, append, and other standard operations into \LFS\ micro-operations. 
%
File system extensions resembling existing stackable file systems generally
use the CFS interface; for example, we wrote a simple module that provides
