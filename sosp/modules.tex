...
name in Linux, but with one critical difference: it is aware of \chdescs.
%
...
through the loopback module as \chdescs, allowing dependency information to be
...
%
The \modules\ create \chdescs\ for
...
will connect the resulting \chdesc\ subgraphs
...
concern themselves with their \chdescs, as the block device
