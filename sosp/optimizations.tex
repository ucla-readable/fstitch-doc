...
Section~\ref{eval}, \Kudos\ allocates an additional 533~MB, which is
predominately for \patches. \Patch\ optimizations reduce this 533~MB
to 40~MB.

This section shows how generic \patch\
