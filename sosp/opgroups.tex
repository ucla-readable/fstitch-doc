...
An \opgroup\ is a bracket around its \chdescs, so that the entire
group can depend on another \opgroup.
%
\Opgroups\ are implemented as an \LFS\ module that imposes \opgroup\
...
%
Using this \chdesc\ arrangement, \anopgroup\ dependency \depends{P}{Q}
is implemented as \depends{\mbox{tail}_P}{\mbox{head}_Q}
