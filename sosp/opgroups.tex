...
so well behaved, so
%
the \patchgroup\ API makes cycles are
inconstructible.
%
...
%
Also, for a metadata-only journal, blocks which are modified as part of a
\patchgroup\ are pulled into the transaction, making the metadata
