...
%
similar scenarios observed in practice led us to invent this type of
 merging.
%
...
hard by dropping its undo data, then merge $h$ into $p$, preserving the
invariant that any block has at most one hard patch.
