...
%
Reliable file systems fundamentally rely on a ``write before'' relationship
 among buffered changes to the data in stable storage.
%
For example, a journal commit record must be written before any changes are
 written to the main body of the file system; soft
 updates~\cite{ganger00soft} and other consistency enforcement mechanisms
