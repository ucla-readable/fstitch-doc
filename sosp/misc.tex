...
\centering \includegraphics[width=.7\hsize]{fig/figures_4} &
\centering \includegraphics[width=.7\hsize]{fig/figures_6}
\end{tabular}
\vskip-\baselineskip
\end{figure}
...
appropriate, but if they cannot be merged, minimal \patches\ generally
result in fewer \patch\ revert operations and more flexibility in write
ordering.
