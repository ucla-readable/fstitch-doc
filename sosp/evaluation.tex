...
\Kudos\ (soft updates) & 5.97 [2.79] & 1.00 [0.31] \\
\Kudos\ (meta journal) & 9.56 [5.49] & 1.65 [0.77] \\
\Kudos\ (full journal) & 13.40 [5.46] & 1.63 [0.77] \\
\Kudos\ (async) & 4.46 [2.10] & 0.82 [0.31] \\ \hline
%FreeBSD (soft updates) & 23.22 & 15.95 \\ 
%FreeBSD (async) & 10.09 & 3.25 \\ \hline
Linux (ext2) & 4.63 [0.73] & 4.52 [0.16] \\
Linux (ext3 ordered) & 13.97 [1.02] & 4.31 [0.24] \\
Linux (ext3 journal) & 11.40 [1.19] & 4.43 [0.22] \\
\end{tabular}
}
