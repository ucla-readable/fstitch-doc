...
CPU, 2GB of RAM, and a Seagate ST3320620AS 320GB 7200 RPM SATA2 disk.
...
disk.\todo{the BSD rm times are suspicious; did we umount/remount for them?}
...
\Kudos\ (ext2 SU) & 16.05 & 6.03 \\ \hline % kudos-mm
\Kudos\ (ext2 async) & 5.27 & 2.99 \\ \hline\hline % kudos-mm
FreeBSD 6.0 (SU) & 23.22 & 15.95 \\ \hline % kudos-pb
FreeBSD 6.0 (async) & 10.09 & 3.25 \\ \hline % kudos-pb
Linux 2.6.20.1 (ext2) & 6.05 & 0.44 \\ \hline % kudos-mm
Linux 2.6.20.1 (ext3) & 12.02 & 0.37 \\ \hline % kudos-mm
\end{tabular}
}
...
\Kudos\ is about 30\% faster than FreeBSD using soft updates for
writes, and about 62\% faster for deletions.\footnote{Interestingly, FreeBSD 5.4
