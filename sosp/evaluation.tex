...
%
Using an fsync per CHECK on a fully journaled file system performs
...
server.
%
Synchronizing to disk once per CHECK with a fully journaled file
...
\centering
\begin{tabular}{@{}llrr@{}}
\textbf{File System} & \textbf{Consistency mechanism} & \textbf{Time} & \textbf{Writes} \\ \hline
...
full journal & fsync per CHECK & 1.3 [0.3] & 26 \\
