...
\safe{ext3 journal} & \safe{12.8 [1.1]} & \safe{4.6 [0.3]} & \safe{69.6 [~~4.5]} & \safe{38.2 [4.0]} \\
\unsafe{ext2} & \unsafe{4.4 [0.7]} & \unsafe{4.6 [0.1]} & \unsafe{35.7 [~~1.9]} & \unsafe{36.9 [4.0]} \\
\unsafe{ext3 journal} & \unsafe{10.6 [1.1]} & \unsafe{4.4 [0.2]} & \unsafe{61.5 [~~4.5]} & \unsafe{37.2 [4.1]} \\
