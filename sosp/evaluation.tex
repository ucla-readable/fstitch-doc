...
None
        & 619,743               & 470.43~MB             & 3.43~sec \\
\Nrb\ \patches\
        & 445,880               & 210.88~MB             & 3.00~sec \\
Overlap merging
        & 109,156               & 260.00~MB             & 2.27~sec \\
Both optimizations
        &  67,361               & 0.33~MB               & 2.45~sec \\
\hline
\multicolumn{4}{@{}c@{}}{\textbf{Delete test}\raise2pt\hbox{\strut}} \\
None
        & 299,089               & 1.46~MB               & 0.83~sec \\
\Nrb\ \patches\
        & 41,113                & 0.93~MB               & 0.27~sec \\
Overlap merging
...
None
        & 250,371               & 176.56~MB             & 1.48~sec \\
\Nrb\ \patches\
        & 155,484               & 86.14~MB              & 1.12~sec \\
Overlap merging
        &  48,158               & 90.27~MB              & 0.71~sec \\
Both optimizations
        &  22,620               & 0.00~MB               & 0.54~sec \\
\hline
\multicolumn{4}{@{}c@{}}{\textbf{Andrew test}\raise2pt\hbox{\strut}} \\
None
        &  70,923               & 65.63~MB              & 5.49~sec \\
\Nrb\ \patches\
        &  50,369               & 37.05~MB              & 5.48~sec \\
Overlap merging
        &  12,527               & 28.57~MB              & 5.24~sec \\
Both optimizations
        &  11,178               & 0.03~MB               & 5.14~sec \\
\end{tabular}
