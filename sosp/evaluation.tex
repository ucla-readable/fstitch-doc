...
\Kudos\ (async) & 4.38 [1.84] & 0.80 [0.29] & 1.46 [0.48] & 37.20 [5.30] \\
\Kudos\ (soft updates) & 5.90 [2.56] & 1.03 [0.32] & 2.54 [0.59] & 44.90 [5.28] \\
\Kudos\ (meta journal) & 8.70 [4.84] & 1.65 [0.75] & 3.48 [1.65] & 37.46 [5.31] \\
\Kudos\ (full journal) & 13.40 [5.46] & 1.63 [0.77] & 5.26 [1.74] & 37.93 [5.38] \\
\Kudos\ (full journal, WB) & ? & ? & ? & ? \\ \hline

%FreeBSD (soft updates) & 23.22 & 15.95 \\ 
%FreeBSD (async) & 10.09 & 3.25 \\ \hline

Linux (ext2) & 4.50 [0.72] & 4.57 [0.16] & 0.22 [0.14] & 37.30 [4.86] \\
Linux (ext3 ordered) & 13.86 [1.01] & 4.29 [0.25] & 0.32 [0.23] & 37.14 [4.89] \\

Linux (ext3 journal) & 10.89 [1.12] & 4.32 [0.26] & 2.66 [0.31] & 37.83 [4.99] \\
Linux (ext3 journal, WT) & 12.74 [1.19] & 4.48 [0.24] & 3.43 [0.29] & 38.85 [5.04] \\
\end{tabular}
}
...
System & Real & Sys & IO & Writes \\ \hline
\Kudos\ (soft updates) & 25.5 & 1.2 & 25.6 & 3015 \\
\Kudos\ (meta journal) & 1.5 & 0.5 & 0.3 & 32 \\
\Kudos\ (full journal) & 1.5 & 0.5 & 0.3 & 33 \\
\Kudos\ (async) & 1.2 & 0.4 & 0.1 & 18 \\ \hline
\Kudos\ (w/o \patchgroups) & ? & ? & ? & ? \\ \hline
Linux (ext2) & 1.5 & 0.3 & 0.5 & 2503 \\
Linux (ext3 ordered) & 2.0 & 0.3 & 0.9 & 3025 \\
Linux (ext3 journal) & 1.8 & 0.3 & 0.7 & 2531 \\ \hline
Linux (ext2) & 16.7 & 0.3 & 15.7 & 2503 \\
Linux (ext3 ordered) & 23.9 & 0.3 & 22.9 & 3025 \\
Linux (ext3 journal) & 20.4 & 0.3 & 19.4 & 2531
\end{tabular}
}
