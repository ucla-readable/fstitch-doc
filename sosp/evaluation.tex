...
%
Although safe results for \Kudos\ and Linux use different mechanisms
(FUA vs a write through cache), we note that \Kudos\ performs
identically in these benchmarks when using either mechanism.
