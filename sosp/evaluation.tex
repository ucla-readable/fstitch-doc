...
None              &   619,740 &   459.41~MB &  3.33~sec \\ % 768~MB 513~MB
\Nrb\ \patches\   &   446,002 &   205.94~MB &  2.73~sec \\ % 515~MB 259~MB
Overlap merging   &   111,486 &   254.02~MB &  1.87~sec \\ % 544~MB 289~MB
Both              &    68,887 &     0.39~MB &  1.83~sec \\ % 293~MB  37~MB
\hline

\multicolumn{4}{@{}c@{}}{\textbf{Delete test}\raise2pt\hbox{\strut}} \\
None              &   299,089 &     1.43~MB &  0.81~sec \\ % 48~MB
\Nrb\ \patches\   &    41,113 &     0.91~MB &  0.24~sec \\ % 20~MB
Overlap merging   &    54,665 &     0.93~MB &  0.31~sec \\ % 21~MB
Both              &     1,800 &     0.00~MB &  0.15~sec \\ % 13~MB
\hline

\multicolumn{4}{@{}c@{}}{\textbf{PostMark test}\raise2pt\hbox{\strut}} \\
None              & 4,591,628 & 3,175.28~MB & 24.46~sec \\ % 5,347~MB 3316MB
\Nrb\ \patches\   & 2,544,300 & 1,583.75~MB & 20.00~sec \\ % 3,674~MB 3674MB
Overlap merging   &   543,738 & 1,587.81~MB & 12.57~sec \\ % 3,649~MB 1618MB
Both              &   624,776 &     0.10~MB & 13.78~sec \\ % 2,068~MB   41MB
\hline

\multicolumn{4}{@{}c@{}}{\textbf{Andrew test}\raise2pt\hbox{\strut}} \\
None              &    70,925 &    64.09~MB &  4.33~sec \\ % 97~MB 69MB
\Nrb\ \patches\   &    50,803 &    36.18~MB &  4.31~sec \\ % 69~MB 41MB
Overlap merging   &    12,466 &    27.91~MB &  4.23~sec \\ % 60~MB 31MB
Both              &    10,398 &     0.04~MB &  4.30~sec \\ % 32~MB  4MB
\end{tabular}
...
\safe{ext3 writeback} & \safe{19.6 [1.0]} & \safe{4.5 [0.2]} & \safe{55.5 [~~3.6]} & \safe{37.6 [4.0]} \\
\safe{ext3 journal} & \safe{17.1 [1.2]} & \safe{4.6 [0.3]} & \safe{80.5 [~~4.7]} & \safe{38.1 [4.0]} \\
\unsafe{ext2} & \unsafe{9.2 [0.7]} & \unsafe{4.5 [0.1]} & \unsafe{45.4 [~~2.0]} & \unsafe{36.8 [4.0]} \\
\unsafe{ext3 journal} & \unsafe{13.3 [1.2]} & \unsafe{4.3 [0.2]} & \unsafe{71.8 [~~4.7]} & \unsafe{37.2 [4.0]} \\
