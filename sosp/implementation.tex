...
unlike traditional file system modules, it is merely a front end to a \Kudos\
\module\ graph. After initialization, individual \modules\ can make file
systems available to mount though the VFS front end. Each file system can be
mounted using a command like \mbox{\texttt{mount -t kfs kfs:\textit{name}
/mnt/point}}.
