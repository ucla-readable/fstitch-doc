...
supports \aemphnoop\ \chdesc\ type\todo{We often refer to non-\noop\ \chdescs. A name for ``prototypical'' \chdescs\ should probably not be defined indirectly as the non-prototypical type.}, which doesn't change the disk at all.
