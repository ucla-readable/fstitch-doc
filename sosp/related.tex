...
%
In particular, xsyncfs provides users with the appearance of synchronous
file system ordering without actually blocking applications on each write.
%
...
apparently-fast strict ordering provided by xsyncfs.
