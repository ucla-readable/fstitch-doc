...
% FIXME: Is the FFS implementation easier for the programmer to manage?
...
information to be separated from the specification. It also allows the
dependency structure to be examined and modified by other \modules\ of the
system that may not have any idea what the changes are actually implementing in
terms of the file system structures they are changing.
