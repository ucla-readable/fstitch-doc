...
dependency. \Opgroup{}-aware applications would require more complex
error logic to handle such errors. For these reasons the \opgroup\
interface is designed to catch all \opgroup{}-related errors in the
\opgroup\ functions. The allowed transitions are shown in
Figure~\ref{fig:opgroup-transitions}.
...
none & released\\
none & abandoned (end)\\
no dependents & engaged\\
engaged & disengaged\\
not released & has dependencies\\
has not been engaged & has dependents
\end{tabular}
