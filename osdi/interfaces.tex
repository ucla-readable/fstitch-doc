...
% FIXME this used to be in the ufs section, it should be integrated right
% around here
...
Figure~\ref{fig:kfs-graph}\todo{Show multiple WB caches?} shows a contrived example taking advantage of the LFS
