...
of the system and thus restricts both what a \module\ can do and how \modules\
...
write-ordering information, which is what \chdescs\ in \Kudos\ provide. We
imagine that systems like these could be adapted to work with \chdescs, giving
