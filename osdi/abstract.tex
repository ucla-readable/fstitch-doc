...
FUSE~\cite{fuse} userspace file system server. Our current
implementation is about a factor of two slower than FreeBSD soft
updates by wall-clock time, and competative with FreeBSD soft updates
for number of blocks written.
