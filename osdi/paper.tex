...
\newcommand{\anopgroup}{a user-level \chdesc}
...
\newcommand{\figfnname}[1]{\texttt{\textbf{#1}}}
\newcommand{\figfn}[3]{\texttt{#1 \figfnname{#2}(#3);}}

\newcommand{\singlespace}{\vspace{-0.5\baselineskip}}
