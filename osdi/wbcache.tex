...
% FIXME: Can you describe the specific algorithm used by the WB cache?
% How many lines of code? Probably should have a bit on the WT cache as well.
...
% FIXME: "rearranged subject to some constraints" -- Such as???? Does
% the elevator scheduler actually improve our benchmarks? Lines of code?
