...
Any in-memory modification to a cached disk block has an associated change
descriptor.
%
Different change types correspond to different forms of change descriptor;
...
state between old to new as necessary.
%
