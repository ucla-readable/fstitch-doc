...
% FIXME Suck content out of the caption to fig:softupdates
...
devices can easily be respected even though the file system containing the image
may not itself use any consistency features, because the change descriptors
...
disks, their write-ordering requirements are still maintained and ultimately
satisfied.
